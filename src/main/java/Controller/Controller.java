    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        if ("upload".equals(action)) {
            ...
            if (title == null || company == null || salary == null || description == null || location == null || deadlineStr == null) {
                request.setAttribute("message", "Please enter all the required information!");
            ...
            try {
                ...
                request.setAttribute("message", "The deadline date is invalid!");
                des = "/layouts/decorator.jsp";
                RequestDispatcher rd = getServletContext().getRequestDispatcher(des);
                rd.forward(request, response);
                return;
            ...
            try {
                ...
                if (success) {
                    ...
                    request.setAttribute("message", "Failed to add job information!");
                    des = "/layouts/decorator.jsp";
                    RequestDispatcher rd = getServletContext().getRequestDispatcher(des);
                    rd.forward(request, response);
                }
        ...
        if ("update".equals(action)) {
            ...
            try {
                ...
                e.printStackTrace();
                request.setAttribute("message", "Update error: " + e.getMessage());
            }
        }
