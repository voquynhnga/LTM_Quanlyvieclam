				...
				<div class='notification-container'>
                                ...
                                <span class="dropdown">
                                    ...
                                    <div class="dropdown-menu" role="menu" style="left: 50%; transform: translateX(-40%);">
                                        <a class="dropdown-item" role="presentation" href="pages/user/account.jsp">Account</a>
                                        <a class="dropdown-item" role="presentation" href="pages/user/login.jsp">Log out</a>
                                           <% 
						                        Integer role = (Integer) session.getAttribute("Role");
						                        if (role != null && role == 1) { 
						                    %>
						                      
						                                <a  class="dropdown-item" role="presentation"  href="pages/manage/manage_user.jsp"> User
						                                </a>
